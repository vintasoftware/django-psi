...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('djangopsi', '0002_auto_20190621_1729'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='report',
            name='report_group',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='djangopsi.ReportGroup'),
        ),
    ]
